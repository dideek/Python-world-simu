...
class Wilk(Zwierze):
    ...
    def kolizja(self, atakujacy):
        if not(isinstance(atakujacy, Wilk)):
            print("Wilk został zaatakowany przez", atakujacy.nazwaGatunku)
            ...
            while (self.czyStoiZwierze(x, y) and ilosc_prob < 50):
                ...
                if i == 0:
                    ...
                    y = atakujacy.polozenieY - 1
            if ilosc_prob < 50:
                print("Wilk się rozmnaża")
                nowywilk = Wilk(x, y, self.swiat, 0)
